...
export const sampleApps: AppData[] = [
  ...
  },
  {
    ...
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fdogoodalways.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
  ...
  },
  {
    ...
    description: "AI-powered platform to help learners navigate the crowded learning marketplace and find their perfect course",
    tags: ["education", "ai", "course-finder", "learning", "recommendation-engine"],
    publishedlink: "https://course-compass-chooser.lovable.app",
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fcourse-compass-chooser.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
  ...
  },
  {
    ...
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fbuild-a-town-play.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
  ...
  },
  {
    ...
    description: "Interactive spelling game for children inspired by The Hangman, making learning to spell fun and engaging",
    tags: ["game", "education", "kids", "spelling", "learning", "word-game"],
    publishedlink: "https://speak-n-spell-buddy.lovable.app",
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fspeak-n-spell-buddy.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
  ...
  },
  {
    ...
    title: "AdRideCRM™",
    description: "Mobile-first platform connecting cab and auto drivers with advertisers to generate extra income through vehicle advertising",
    tags: ["crm", "advertising", "mobile-app", "gig-economy", "marketplace", "revenue"],
    publishedlink: "https://adride-drive-earn.lovable.app",
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fadride-drive-earn.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
  ...
  },
  {
    ...
    title: "Pause",
    description: "Voice-guided emergency support platform with sensory-safe UI for neurodivergent users to handle panic, stress, and cognitive overload",
    tags: ["mental-health", "accessibility", "neurodivergent", "adhd", "wellness", "crisis-support"],
    publishedlink: "https://letspause.lovable.app",
    thumbnail: "https://api.microlink.io/?url=https%3A%2F%2Fletspause.lovable.app&screenshot=true&meta=false&embed=screenshot.url",
